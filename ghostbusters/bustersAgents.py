...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for distance in livingGhostPositionDistributions:
            ghostPosition.append(distance.sortedKeys()[0])
        #print "Ghost Positions: ",ghostPosition
        ...
        #print "Minimum Ghost Position: ", minGhostPosition
        action = None
        for move in legal:
            successorPosition = Actions.getSuccessor(pacmanPosition, move)
            successorDistance = self.distancer.getDistance(successorPosition, minGhostPosition)
            if successorDistance < minGhostDistance:
                minGhostDistance = successorDistance
                action = move
        return action
        "*** YOUR CODE HERE ***"
